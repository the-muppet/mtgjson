...
pub struct MtgjsonSetObject {
    // Availability fields for set-level platform availability
    #[pyo3(get, set)]
    #[serde(deserialize_with = "deserialize_bool_or_string", default)]
    pub arena: bool,
    ...
    #[pyo3(get, set)]
    pub translations: MtgjsonTranslationsObject,
...
impl MtgjsonSetObject {
    ...
    pub fn new() -> Self {
        Self {
            ...
            token_set_code: None,
            total_set_size: 0,
            translations: MtgjsonTranslationsObject::new(None),
            type_: String::new(),
