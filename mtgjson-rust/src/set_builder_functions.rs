...
) -> Vec<crate::card::MtgjsonCardObject> {
    set_builder::build_base_mtgjson_cards(set_code, None, is_token, set_release_date)
}

/// Build sealed products for a set
#[pyfunction]
pub fn build_sealed_products(set_code: &str) -> Vec<crate::sealed_product::MtgjsonSealedProductObject> {
    set_builder::build_sealed_products(set_code)
}

/// Build decks for a set
#[pyfunction]
pub fn build_decks(set_code: &str) -> Vec<crate::deck::MtgjsonDeckObject> {
    set_builder::build_decks(set_code)
}

/// Enhance cards with additional metadata
#[pyfunction]
pub fn enhance_cards_with_metadata(mut mtgjson_cards: Vec<crate::card::MtgjsonCardObject>) -> Vec<crate::card::MtgjsonCardObject> {
