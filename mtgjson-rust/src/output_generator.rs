...
impl OutputGenerator {
    ...
    pub fn build_all_printings_files(&self) -> PyResult<()> {
        // High-performance AllPrintings generation
    ...
    /// Build format-specific AllPrintings files (Standard, Pioneer, Modern, etc.)
    pub fn build_format_specific_files(&self, all_printings: &MtgjsonAllPrintings) -> PyResult<()> {
        ...
        // Generate each format file
        for (format_name, _set_codes) in format_map {
            // Filter AllPrintings data for this format
    ...
    /// Build atomic cards files with format splits
    ...
    /// Build format-specific atomic cards (StandardCards, ModernCards, etc.)
    ...
    /// Generate compiled prices output with compression
    pub fn generate_compiled_prices_output(&self) -> PyResult<()> {
        // This would integrate with the PriceBuilder
    ...
    /// High-performance file writing with proper JSON structure
    pub fn create_compiled_output(&self, filename: &str, data_json: String) -> PyResult<()> {
        ...
        // Parse input JSON and create MTGJSON structure with metadata
    ...
    /// Fast format map construction with caching
    pub fn construct_format_map(&self) -> PyResult<HashMap<String, Vec<String>>> {
        // High-performance format mapping
    ...
    /// Fast atomic cards format mapping
    ...
    /// Filter AllPrintings data by format (high performance)
    pub fn filter_all_printings_by_format(
        ...
        // This would use the actual data structures
