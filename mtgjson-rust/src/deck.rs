...
pub struct MtgjsonDeck {
    ...
    pub main_board: Vec<String>, // JSON strings instead of PyJsonValue
    
    #[pyo3(get, set)]
    #[serde(skip_serializing_if = "skip_if_empty_vec")]
    pub side_board: Vec<String>, // JSON strings instead of PyJsonValue
    
    #[pyo3(get, set)]
    #[serde(skip_serializing_if = "skip_if_empty_vec")]
    pub display_commander: Vec<String>, // JSON strings instead of PyJsonValue
    
    #[pyo3(get, set)]
    #[serde(skip_serializing_if = "skip_if_empty_vec")]
    pub commander: Vec<String>, // JSON strings instead of PyJsonValue
    
    #[pyo3(get, set)]
    #[serde(skip_serializing_if = "skip_if_empty_vec")]
    pub planes: Vec<String>, // JSON strings instead of PyJsonValue
    
    #[pyo3(get, set)]
    #[serde(skip_serializing_if = "skip_if_empty_vec")]
    pub schemes: Vec<String>, // JSON strings instead of PyJsonValue
