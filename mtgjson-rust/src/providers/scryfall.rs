...
use super::{AbstractProvider, BaseProvider, RateLimiter, ProviderError, ProviderResult};
...
impl ScryfallProvider {
    ...
    pub fn download_cards<'py>(
        ...
        self.download_all_pages(py, &url, None)
    }
...
impl ScryfallProvider {
    ...
    fn build_http_header_static() -> HashMap<String, String> {
        let mut headers = HashMap::new();
        
        // In a real implementation, you'd read from configuration
