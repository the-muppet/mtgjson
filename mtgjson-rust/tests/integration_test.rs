...
mod tests {
    ...
    fn test_card_python_methods() {
        let mut card1 = MtgjsonCard::new(false);
        ...
        let mut card2 = MtgjsonCard::new(false);
        ...
        assert_eq!(repr_str, "MtgjsonCard(name='Lightning Bolt', set_code='LEA', uuid='12345-67890')");
    ...
    fn test_backwards_compatibility() {
        let card1 = MtgjsonCard::new(false);
        let card2 = MtgjsonCard::new(false);
    ...
    fn test_json_object_trait() {
        let card = MtgjsonCard::new(false);
